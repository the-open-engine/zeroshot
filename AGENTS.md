...
## Conductor System: 3D Classification → Parameterized Templates

**Conductor classifies tasks on 3 dimensions, routes to base templates with parameters.**

### Classification Dimensions

**Domain (what area):**

- CODE: features, bugs, refactoring
- INFRA: Terraform, K8s, AWS
- CICD: GitHub Actions, pipelines
- OPS: logs, monitoring, debugging
- TESTING: E2E, unit tests
- CONTEXT: CLAUDE.md, skills, prompts
...
**4 base templates replace 72 static configs:**
...
- `domain` → domain-specific guidance in prompts
