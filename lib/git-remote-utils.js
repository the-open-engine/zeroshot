 ...
 *
 * Note: Gitea/self-hosted instances are not auto-detected (no reliable pattern).
 * Use --gitea flag or configure settings (defaultIssueSource, giteaInstance).
 *
...
function parseGitRemoteUrl(remoteUrl) {
  ...
  if (httpsMatch) {
    ...
    if (host === 'github.com') {
      ...
      // Unknown provider (could be self-hosted Gitea, GitLab, etc.)
      // Return null to fall back to settings or CLI flags (e.g., --gitea)
      return null;
    }
