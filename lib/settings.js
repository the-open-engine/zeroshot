...
// NOTE: Do NOT cache the module - always re-require to ensure fresh exports,
// especially after tests clear the require cache for settings.js
function getIssueProviderFns() {
  // Delete cache entry to ensure we get fresh exports (critical for test environment)
  const modulePath = require.resolve('../src/issue-providers');
  delete require.cache[modulePath];
  return require('../src/issue-providers');
}
