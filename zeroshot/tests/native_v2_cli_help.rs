...
fn help_explains_delivery_authentication_and_local_run_safety() {
    ...
    assert_prose(
        ...
        &[
            ...
            "ctrl-c before submission cancels the command",
            "during submission it waits for the receipt, then detaches",
            "during observation it detaches without stopping the run",
            "--ship",
