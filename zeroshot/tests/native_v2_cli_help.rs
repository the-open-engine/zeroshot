...
fn help_explains_delivery_authentication_and_local_run_safety() {
    ...
    assert_prose(
        ...
        &[
            ...
            "ctrl-c before the submission attempt begins cancels the command",
            "once it begins, ctrl-c waits for the receipt and then detaches",
            "during observation, ctrl-c detaches without stopping the run",
            "--ship",
